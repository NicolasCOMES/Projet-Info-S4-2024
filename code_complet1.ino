...
void loop() {
  ...
  int Temperature = random(30, 45); // Génère une température aléatoire entre 35 et 40
  int BPM = random(60, 80); // Génère des battements aléatoires
  int Frequence_respiratoire = random(15, 35); // Génère des fréquences respiratoires aléatoires

  String Message = "Saucisson:" + String(coordonneeX) + ":" + String(coordonneeY) + ":" + String(Temperature) + ":" + String(BPM) + ":" + String(Frequence_respiratoire);
